...
CREATE TABLE `book` (
  ...
  `rfid` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
INSERT INTO `book` (`id`, `name`, `author`, `quantity`, `price`, `description`, `rfid`) VALUES
(2, 'Himu', 'Abul', 100, 50, 'This is a good book', '5566998'),
(4, 'Science fiction', 'julvern', 10, 50, 'nice', '445578'),
(5, 'Golpo somogro', 'robindronath thakur', 10, 500, 'nice book', '445578');
...
(3, 0, 3, '2022-11-13 23:08:12', '0000-00-00 00:00:00', 11569877, 0);
...
CREATE TABLE `sensor` (
  `id` int(10) NOT NULL,
  `students_id` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fingerprint` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `sensor` (`id`, `students_id`, `fingerprint`) VALUES
(1, '445578', 'fjgnsflknsfnlk');
...
(8, 'abul', 'hasan', 'abul@gmail.com', 5566998, 'srogvknfslkff24123vs31313sc1', 5, 'eee'),
(9, 'korim', 'khan', 'karim@mail.com', 5566998, 'fjgnsflknsfnlk', 4, 'cse');
